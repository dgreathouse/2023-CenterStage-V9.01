...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoBackdropRed_Play_5;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoBackdropRed_Play_5;
...
@Autonomous(name = "Backdrop Red Play 5", group = "Auto Backdrop Red")
public class AutoBackdropRedOpMode_Play_5 extends CommandOpMode {
    ...
    GAutoBackdropRed_Play_5 Gauto;
    BAutoBackdropRed_Play_5 Bauto;
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
        	Bauto = new BAutoBackdropRed_Play_5(this, drive,arm);
        }else {
        	Gauto = new GAutoBackdropRed_Play_5(this, drive,arm);
        }
