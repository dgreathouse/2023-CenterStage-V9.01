...
public class WingBlueStartCommand extends SequentialCommandGroup {
    public WingBlueStartCommand(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
        addCommands(
