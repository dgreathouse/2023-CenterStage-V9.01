...
public class GAutoBackdropBlueParkMiddleGetTwo extends SequentialCommandGroup {

    public GAutoBackdropBlueParkMiddleGetTwo(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
