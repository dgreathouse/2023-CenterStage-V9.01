...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoWingRed_Play_2;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoWingRed_Play_2;
...
public class AutoWingRedOpMode_Play_2 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
            Bauto = new BAutoWingRed_Play_2(this, drive,arm,claw);
        }else {
            Gauto = new GAutoWingRed_Play_2(this, drive,arm,claw);
        }
