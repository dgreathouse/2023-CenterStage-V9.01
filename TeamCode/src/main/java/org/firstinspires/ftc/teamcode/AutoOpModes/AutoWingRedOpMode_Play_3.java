...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoWingRed_Play_3;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoWingRed_Play_3;
...
public class AutoWingRedOpMode_Play_3 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new GAutoWingRed_Play_3(this, drive,arm);
        }else {
        	Bauto = new BAutoWingRed_Play_3(this, drive,arm);
        }
