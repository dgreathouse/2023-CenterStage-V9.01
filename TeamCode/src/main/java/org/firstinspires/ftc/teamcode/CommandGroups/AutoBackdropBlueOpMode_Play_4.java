...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropBlue_Play_4;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropBlue_Play_4;
...
public class AutoBackdropBlueOpMode_Play_4 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropBlue_Play_4(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropBlue_Play_4(this, drive,arm);
        }
