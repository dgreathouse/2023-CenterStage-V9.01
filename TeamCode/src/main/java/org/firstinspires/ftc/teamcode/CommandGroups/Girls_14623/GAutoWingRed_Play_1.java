...
public class GAutoWingRed_Play_1 extends SequentialCommandGroup {
    ...
    public GAutoWingRed_Play_1(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw)  {
        ...
        addCommands(
                ...
                new AutoRotateRobot(_opMode,_drive, 0,0.25,3.0),                                     // Rotate robot straight
                new AutoDriveTimeVel(_opMode, _drive,-180,0.4,0,1.22,1.0,0.2),                                // Drive backwards to a the wall
                new AutoRotateRobot(_opMode,_drive, 90,0.25,3.0),                                    // Rotate so back is towards the backdrop
                new AutoDriveTimeVel(_opMode, _drive,90,0.4,90,3.0,1.0,1.0),                                 // Drive to parking area
                new AutoDriveTimeVel(_opMode, _drive,90,0.4,-90,1.7,1.0,0.5),                                 // Drive to parking area
