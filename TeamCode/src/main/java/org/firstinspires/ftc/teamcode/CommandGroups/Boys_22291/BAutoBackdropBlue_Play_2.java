...
public class BAutoBackdropBlue_Play_2 extends SequentialCommandGroup {
    ...
    public BAutoBackdropBlue_Play_2(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
        ...
        addCommands(
                ...
                new AutoDriveTimeVel(_opMode, _drive,90,0.3,90,550,true),                                // sign
                new AutoDriveTimeVel(_opMode, _drive,180,0.3,90,1700,false),                              // sign
