...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropBlue_Play_1;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropBlue_Play_1;
...
@Autonomous(name = "Backdrop Blue Play 1", group = "Auto Wing Blue")
public class AutoBackdropBlueOpMode_Play_1 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropBlue_Play_1(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropBlue_Play_1(this, drive,arm);
        }
