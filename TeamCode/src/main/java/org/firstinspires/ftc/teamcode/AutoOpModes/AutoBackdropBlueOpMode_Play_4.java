...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoBackdropBlue_Play_4;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoBackdropBlue_Play_4;
...
@Autonomous(name = "Backdrop Blue Play 4", group = "Auto Backdrop Blue")
public class AutoBackdropBlueOpMode_Play_4 extends CommandOpMode {
    ...
    GAutoBackdropBlue_Play_4 Gauto;
    BAutoBackdropBlue_Play_4 Bauto;
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
        	Bauto = new BAutoBackdropBlue_Play_4(this, drive,arm);
        }else {
        	Gauto = new GAutoBackdropBlue_Play_4(this, drive,arm);
        }
