...
public class GWingBlueMiddleToBackdrop extends SequentialCommandGroup {
    ...
    public GWingBlueMiddleToBackdrop(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw)  {
        ...
        addCommands(
                ...
                new ArmAutoGotoPosition(_opMode, _arm, 35, -10, 0),                             // Set arm to go undertruss
                ...
                new AutoDriveTimeVel(_opMode, _drive, 90, 0.8, 0,1.05),                        // Drive to the right
                new AutoDriveTimeVel(_opMode, _drive, 0, 0.8, 0,2.05),                          // Drive forward to middle of field
                ...
                new ArmAutoGotoPosition(_opMode, _arm, 35, 20, 0),                              // Set arm to backdrop
