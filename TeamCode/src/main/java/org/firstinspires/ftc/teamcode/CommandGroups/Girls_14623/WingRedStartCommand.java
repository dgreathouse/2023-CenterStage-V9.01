...
public class WingRedStartCommand extends SequentialCommandGroup {
    public WingRedStartCommand(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
        addCommands(
                new InstantCommand(_drive::resetYaw),                                           // Reset the gyro
                new AutoDelayCommand(_opMode, 0.75),                                            // Wait for claw to close
