...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropRed_Play_1;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropRed_Play_1;
...
public class AutoBackdropRedOpMode_Play_1 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropRed_Play_1(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropRed_Play_1(this, drive,arm);
        }
