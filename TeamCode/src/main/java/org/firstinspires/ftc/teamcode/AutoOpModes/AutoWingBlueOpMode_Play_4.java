...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoWingBlue_Play_4;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoWingBlue_Play_4;
...
public class AutoWingBlueOpMode_Play_4 extends CommandOpMode {
    ...
    GAutoWingBlue_Play_4 Gauto;
    BAutoWingBlue_Play_4 Bauto;
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
        	Bauto = new BAutoWingBlue_Play_4(this, drive,arm);
        }else {
        	Gauto = new GAutoWingBlue_Play_4(this, drive,arm);
        }
