...
public class GAutoBackdropBlueParkWallGetTwo extends SequentialCommandGroup {

    public GAutoBackdropBlueParkWallGetTwo(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
