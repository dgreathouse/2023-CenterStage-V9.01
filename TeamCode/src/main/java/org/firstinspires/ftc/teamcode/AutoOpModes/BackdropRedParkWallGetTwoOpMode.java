...
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoBackdropRedParkWallGetTwo;
...
@Autonomous(name = "Backdrop Red Park Wall Get 2", group = "Auto Backdrop Red")
public class BackdropRedParkWallGetTwoOpMode extends CommandOpMode {
    ...
    GAutoBackdropRedParkWallGetTwo Gauto;
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
            ...
            Gauto = new GAutoBackdropRedParkWallGetTwo(this, drive,arm,claw);
        }
