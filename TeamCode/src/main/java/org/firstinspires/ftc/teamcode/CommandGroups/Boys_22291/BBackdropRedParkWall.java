...
public class BBackdropRedParkWall extends SequentialCommandGroup {

    public BBackdropRedParkWall(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw)  {
