...
public class GAutoWingRed_Play_3 extends SequentialCommandGroup {
    ...
    public GAutoWingRed_Play_3(CommandOpMode _opMode, DriveSubsystem _drive, ArmAutoSubsystem _arm, ClawAutoGripSubsystem _claw) {
        ...
        addCommands(
                ...
                new AutoDriveTimeVel(_opMode, _drive,-90,0.4,90,800),
