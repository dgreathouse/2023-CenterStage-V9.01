...
public class BackdropBlueStartCommand extends SequentialCommandGroup {
    public BackdropBlueStartCommand(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
        addCommands(
