...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropRed_Play_4;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropRed_Play_4;
...
public class AutoBackdropRedOpMode_Play_4 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropRed_Play_4(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropRed_Play_4(this, drive,arm);
        }
