...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoBackdropRed_Play_4;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoBackdropRed_Play_4;
...
@Autonomous(name = "Backdrop Red Play 4", group = "Auto Backdrop Red")
public class AutoBackdropRedOpMode_Play_4 extends CommandOpMode {
    ...
    GAutoBackdropRed_Play_4 Gauto;
    BAutoBackdropRed_Play_4 Bauto;
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
        	Bauto = new BAutoBackdropRed_Play_4(this, drive,arm);
        }else {
        	Gauto = new GAutoBackdropRed_Play_4(this, drive,arm);
        }
