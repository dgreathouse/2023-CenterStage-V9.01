...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropBlue_Play_3;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropBlue_Play_3;
...
@Autonomous(name = "Backdrop Blue Play 3", group = "Auto Wing Blue")
public class AutoBackdropBlueOpMode_Play_3 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropBlue_Play_3(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropBlue_Play_3(this, drive,arm);
        }
