...
public class WingWallToBackdrop extends SequentialCommandGroup {
    ...
    public WingWallToBackdrop(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw)  {
        ...
        addCommands(
                ...
                new InstantCommand(() -> _arm.setArmData(35,15,0)),                             // Raise the arm to the backdrop
                new AutoDelayCommand(_opMode, 1.0),                                             // TODO: Add a delay if teams need it
                ...
                new AutoDriveToPark(_opMode, _drive),
                new InstantCommand(() -> _arm.setArmData(0,0,0)),                            // Raise the arm to the backdrop
                new AutoDelayCommand(_opMode, 1)
