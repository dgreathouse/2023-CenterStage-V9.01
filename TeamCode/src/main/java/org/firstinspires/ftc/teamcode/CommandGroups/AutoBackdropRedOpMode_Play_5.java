...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropRed_Play_5;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropRed_Play_5;
...
public class AutoBackdropRedOpMode_Play_5 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropRed_Play_5(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropRed_Play_5(this, drive,arm);
        }
