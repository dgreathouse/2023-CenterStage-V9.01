...
import org.firstinspires.ftc.teamcode.CommandGroups.22291.BAutoBackdropBlue_Play_2;
import org.firstinspires.ftc.teamcode.CommandGroups.14623.GAutoBackdropBlue_Play_2;
...
public class AutoBackdropBlueOpMode_Play_2 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNunber == 22291) {
        	Gauto = new BAutoBackdropBlue_Play_2(this, drive,arm);
        }else {
        	Bauto = new GAutoBackdropBlue_Play_2(this, drive,arm);
        }
