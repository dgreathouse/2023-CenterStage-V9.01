...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoWingBlue_Play_5;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoWingBlue_Play_5;
...
@Autonomous(name = "Wing Blue Play 5", group = "Auto Wing Blue")
public class AutoWingBlueOpMode_Play_5 extends CommandOpMode {
    ...
    GAutoWingBlue_Play_5 Gauto;
    BAutoWingBlue_Play_5 Bauto;
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
        	Bauto = new BAutoWingBlue_Play_5(this, drive,arm);
        }else {
        	Gauto = new GAutoWingBlue_Play_5(this, drive,arm);
        }
