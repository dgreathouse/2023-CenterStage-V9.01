...
import org.firstinspires.ftc.teamcode.CommandGroups.Boys_22291.BAutoBackdropBlue_Play_5;
import org.firstinspires.ftc.teamcode.CommandGroups.Girls_14623.GAutoBackdropBlue_Play_5;
...
@Autonomous(name = "Backdrop Blue Play 5", group = "Auto Backdrop Blue")
public class AutoBackdropBlueOpMode_Play_5 extends CommandOpMode {
    ...
    private void createCommandGroup() {
        if(GlobalData.TeamNumber == 22291) {
        	Bauto = new BAutoBackdropBlue_Play_5(this, drive,arm);
        }else {
        	Gauto = new GAutoBackdropBlue_Play_5(this, drive,arm);
        }
