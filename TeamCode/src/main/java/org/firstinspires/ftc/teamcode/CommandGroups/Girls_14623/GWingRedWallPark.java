...
public class GWingRedWallPark extends SequentialCommandGroup {

    public GWingRedWallPark(CommandOpMode _opMode, AutoDriveSubsystem _drive, AutoArmSubsystem _arm, AutoClawGripSubsystem _claw) {
